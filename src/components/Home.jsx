    ...
    <div name="home" className="w-full h-screen bg-[#0a192f]">
      <div className="max-w-[1000px] mx-auto px-8 h-full flex flex-col justify-center font-serif">
        ...
        <Typed
          ...
          loop
        />
        <h2 className="text-3xl sm:text-6xl font-bold text-[#c1c4ce]">
          I'm a Full-Stack Developer
        </h2>
        <h3 className="text-2xl sm:text-5xl font-bold text-[#8892b0]">
          Based in Nigeria
        </h3>
        <p className="text-[#8892b0] py-8 max-w-[500px]">
          I'm a full-stack developer specializing in building exceptional digital
          experiences. currently, I'm focused on building reponsive front-end
          web applications.{" "}
        </p>
        <div>
