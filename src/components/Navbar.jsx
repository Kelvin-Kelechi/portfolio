  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between  items-center px-4 bg-[#0a192f] text-gray-300 font-serif'>
        ...
        <div onClick={handleClick} className='md:hidden z-10 text-orange-500'>
            {!nav ? <AiOutlineMenu size={30}/> : <AiOutlineClose size={30}/> }</div>
        {/*Mobile-menu*/}
         
         <ul   className={!nav? 'fixed left-[-100%]':'fixed w-[100%] text-center backdrop-blur-sm left-0 top-[80px] bg-black/60 h-full border-r border-gray-800 bg-blue ease-in-out duration-500 '}>
        ...
        <div  className='hidden lg:flex flex-col fixed top-[35%] left-0'>
            <ul>
                 <li className='w-[160px] h-[60px] flex justify-between ml-[-100px] hover:ml-[10px] duration-300 bg-blue-600'>
                    <a href="https://www.linkedin.com/in/angigor-kelvin-21162023b/" className='flex justify-between items-center w-full text-gray-300 '>
