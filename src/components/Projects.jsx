...
const Projects = () => {
  return (
    <div
      name="work"
      className="w-full bg-[#0a192f] text-gray-300 md:h-screen font-serif"
    >
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center h-full w-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://netgo.netlify.app">
                  <button className="text-center rounded-lg px-4 py-3 ml-2 bg-white text-gray-700 text-lg font-bold">
                    Demo
                  </button>
                </a>
                <a href="https://github.com/Kelvin-Kelechi/netflix-project">
                  <button className="text-center rounded-lg px-4 py-3 ml-2 bg-white text-gray-700 text-lg font-bold">
                    Code
                  </button>
                </a>
          ...
          <div
            style={{ backgroundImage: `url(${Cryto})` }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            <div className="opacity-0 group-hover:opacity-100">
              <p className="text-2xl font-bold text-white  tracking-wider text-center">
              ...
              <div className="pt-8 text-center">
                ...
                <a href="https://github.com/Kelvin-Kelechi/crypto-project">
                  <button className="text-center rounded-lg px-4 py-3 ml-2 bg-white text-gray-700 text-lg font-bold">
                    Code
                  </button>
                </a>
          ...
          >
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                ...
                <a href="https://github.com/Kelvin-Kelechi/defi">
                  <button className="text-center rounded-lg px-4 py-3 ml-2 bg-white text-gray-700 text-lg font-bold">
                    Code
                  </button>
                </a>
          ...
          <div
            style={{ backgroundImage: `url(${Secured})` }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            <div className="opacity-0 group-hover:opacity-100">
              <p className="text-2xl font-bold text-white  tracking-wider text-center">
              ...
              <div className="pt-8 text-center">
                ...
                <a href="https://github.com/Kelvin-Kelechi/secure-data">
                  <button className="text-center rounded-lg px-4 py-3 ml-2 bg-white text-gray-700 text-lg font-bold">
                    Code
                  </button>
                </a>
          ...
          <div
            style={{ backgroundImage: `url(${Kreact})` }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            <div className="opacity-0 group-hover:opacity-100">
              <p className="text-2xl font-bold text-white  tracking-wider text-center">
